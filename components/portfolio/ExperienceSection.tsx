                    ...
                    <div className="space-y-8">
                        {experiences.map((exp, i) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Timeline dot */}
                                    <div className={`absolute left-[-24px] md:left-[-32px] top-6 w-3 h-3 rounded-full border-2 ${isCurrent ? 'bg-brand-500 border-brand-400 shadow-[0_0_12px_rgba(139,92,246,0.6)]' : 'bg-zinc-800 border-zinc-700'}`} />

                                    <SpotlightCard
                                        className={`p-6 cursor-pointer ${isCurrent ? 'border-brand-500/15' : ''}`}
                                        spotlightColor={isCurrent ? "rgba(139, 92, 246, 0.18)" : "rgba(139, 92, 246, 0.1)"}
                                    >
