    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col items-center lg:items-start gap-6 md:gap-8 order-1 lg:order-1 text-center lg:text-left lg:pr-12" style={{ transform: 'translateZ(50px)' }}>
                    {/* Status Badge */}
                ...
                <div className="relative order-2 lg:order-2 flex justify-center lg:justify-end xl:justify-center" style={{ transform: 'translateZ(100px)' }}>
